    ...
    return (
        ...
        <div className="container-xxl py-5">
            <div className="container">
                <h1 className="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">APPLICATIONS FOR (JOB TITLE)</h1>
                <div className="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div className="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            ...
                            <div className="job-item p-4 mb-4">
                                <div className="row g-4">
                                    <div className="col-sm-12 col-md-8 d-flex align-items-center">
                                        ...
                                        <Link className="mb-3" to="/student/profile">
                                            <h5>NAME HERE</h5>
                                        </Link>
                                            <Link to='/'>Download CV</Link>
                                            <Link to='/application/details'>Details</Link>
                                        </div>
                                    </div>
                                    <div className="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                    <div className="d-flex mb-3 justify-content-between" style={{width:'45%'}}>
                                            <Link className="btn btn-sm btn-success" to="/updatejob">Accept</Link>
                                            <Link className="btn btn-sm btn-danger" to="/apply">Reject</Link>
                                        </div>
                            ...
                            {/* job item 2 ends */}
                            <a className="btn btn-success py-3 px-5" href="#">Browse More Applications</a>
                        </div>
                    </div>
                </div>
            </div>
