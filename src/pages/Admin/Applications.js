...
<div className="table-wrapper">
    <table className="fl-table">
        ...
        <tr>
            <td className='tableRow'>Job Title</td>
            <td className='tableRow'>khan</td>
            <td className='tableRow'>1/2/20073</td>
            <td className='tableRow'>Accepted</td>
            <td className='tableRow'>
              <Link to="/admin/application/details">
              See
              </Link>
              </td>
            <td>
